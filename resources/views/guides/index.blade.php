...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 opacity-0 animate-[fadeIn_0.3s_ease-out_50ms_forwards]">
        <a href="{{ route('guides.show', 'teams') }}" class="block bg-surface-1 border border-border rounded-none p-6 hover:border-border-light hover:bg-surface-2 transition-all group">
            <div class="w-10 h-10 bg-surface-2 rounded-none flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <h3 class="text-base font-medium text-text-primary mb-2">Workspaces & Members</h3>
            <p class="text-text-secondary text-[13px]">Workspaces, roles, invitations, and privacy settings.</p>
        </a>

        <a href="{{ route('guides.show', 'tickets') }}" class="block bg-surface-1 border border-border rounded-none p-6 hover:border-border-light hover:bg-surface-2 transition-all group">
            <div class="w-10 h-10 bg-surface-2 rounded-none flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <a href="{{ route('guides.show', 'portal') }}" class="block bg-surface-1 border border-border rounded-none p-6 hover:border-border-light hover:bg-surface-2 transition-all group">
            <div class="w-10 h-10 bg-surface-2 rounded-none flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            <p class="text-text-secondary text-[13px]">Explore public workspaces and submit tickets as a logged-in user.</p>
        </a>

        <a href="{{ route('guides.show', 'robots') }}" class="block bg-surface-1 border border-border rounded-none p-6 hover:border-border-light hover:bg-surface-2 transition-all group">
            <div class="w-10 h-10 bg-surface-2 rounded-none flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <a href="{{ route('guides.show', 'api-reference') }}" class="block bg-surface-1 border border-border rounded-none p-6 hover:border-border-light hover:bg-surface-2 transition-all group md:col-span-2">
            <div class="w-10 h-10 bg-surface-2 rounded-none flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
    ...
    <p class="text-text-secondary mb-6 leading-relaxed">
        Ticket Hub is built around <strong>Workspaces</strong>. Each workspace has its own ecosystem:
    </p>
    <ul class="space-y-3 mb-8">
        <li class="flex items-start gap-3">
            <div class="w-1.5 h-1.5 rounded-none bg-accent mt-2"></div>

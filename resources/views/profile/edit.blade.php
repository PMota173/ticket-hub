                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', auth()->user()->name) }}" required 
                            class="w-full bg-surface-2 border border-border text-text-primary rounded-none px-4 py-2.5 focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_var(--color-accent-glow)] transition-all duration-150 text-[13px] placeholder-text-muted">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="bio" id="bio" rows="5" 
                            class="w-full bg-surface-2 border border-border text-text-primary rounded-none px-4 py-3 focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_var(--color-accent-glow)] transition-all duration-150 placeholder-text-muted resize-none text-[13px] leading-relaxed"
                    ...
                    <div class="space-y-2.5">
                        ...
                        <div class="flex items-center gap-6 p-5 rounded-none bg-surface-2 border border-border">
                            <!-- Current Preview -->
                            <div class="flex-shrink-0">
                                @if(auth()->user()->avatar_path)
                                    <img src="{{ asset('storage/' . auth()->user()->avatar_path) }}" 
                                         alt="Current Avatar" 
                                         class="w-16 h-16 rounded-none object-cover border border-border">
                                @else
                                    <div class="w-16 h-16 rounded-none bg-surface-3 flex items-center justify-center border border-border">

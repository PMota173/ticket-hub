<aside class="w-72 bg-slate-900 border-r border-slate-800 flex flex-col h-screen sticky top-0">
    ...
    <div class="p-6">
        ...
        <nav class="space-y-1">
            ...
            <a href="{{ route('my-invitations.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('my-invitations.index') ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">

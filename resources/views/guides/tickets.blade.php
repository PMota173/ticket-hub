...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-surface-1 border border-border rounded-none p-6">
            <div class="flex items-center gap-3 mb-2">
                <span class="w-2.5 h-2.5 rounded-none bg-accent"></span>
        ...
        <div class="bg-surface-1 border border-border rounded-none p-6">
            <div class="flex items-center gap-3 mb-2">
                <span class="w-2.5 h-2.5 rounded-none bg-purple-500"></span>
        ...
        <div class="bg-surface-1 border border-border rounded-none p-6">
            <div class="flex items-center gap-3 mb-2">
                <span class="w-2.5 h-2.5 rounded-none bg-orange-500"></span>
        ...
        <div class="bg-surface-1 border border-border rounded-none p-6">
            <div class="flex items-center gap-3 mb-2">
                <span class="w-2.5 h-2.5 rounded-none bg-green-500"></span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div class="bg-surface-2 p-5 rounded-none border border-border">

<x-layouts.app title="Feed - {{ config('app.name', 'Ticket Hub') }}" sidebar="global">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-3xl font-bold tracking-tight text-white">Your Feed</h2>
                <p class="text-slate-400 mt-2">Overview of your teams and recent activity.</p>
            </div>
        ...
        @if($teams->isEmpty())
            <div class="bg-slate-900/50 border border-slate-700 rounded-xl p-12 text-center">
                ...
                <h3 class="text-xl font-semibold text-white mb-2">Welcome to Ticket Hub!</h3>

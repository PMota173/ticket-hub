...
@if($priority === \App\Enums\TicketPriority::HIGH)
    <span {{ $attributes->merge(['class' => 'inline-flex items-center px-2 py-0.5 rounded-[4px] text-[12px] font-medium bg-danger/15 text-danger border border-danger/20']) }}>
...
@elseif($priority === \App\Enums\TicketPriority::MEDIUM)
    <span {{ $attributes->merge(['class' => 'inline-flex items-center px-2 py-0.5 rounded-[4px] text-[12px] font-medium bg-warning/15 text-warning border border-warning/20']) }}>
...
@elseif($priority === \App\Enums\TicketPriority::LOW)
    <span {{ $attributes->merge(['class' => 'inline-flex items-center px-2 py-0.5 rounded-[4px] text-[12px] font-medium bg-success/15 text-success border border-success/20']) }}>
...
@else
    <span {{ $attributes->merge(['class' => 'inline-flex items-center px-2 py-0.5 rounded-[4px] text-[12px] font-medium bg-surface-2 text-text-secondary border border-border']) }}>
